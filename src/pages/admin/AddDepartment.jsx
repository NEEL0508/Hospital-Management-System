...
import { Info, User, BarChart2 } from 'lucide-react';
    ...
    <div style={{ backgroundColor: '#f8fafc', minHeight: 'calc(100vh - 80px)', padding: '2rem', display: 'flex', justifyContent: 'center' }}>
      <div style={{ width: '100%', maxWidth: '1200px' }}>
        ...
        <div style={{ fontSize: '0.875rem', color: '#94a3b8', marginBottom: '1.5rem', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
          ...
          <span>&rsaquo;</span>
          <span style={{ color: '#1e293b', fontWeight: 600 }}>Add Department</span>
        </div>

        {/* Header Section */}
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem' }}>
          <div>
            <h1 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#1e293b', marginBottom: '0.5rem' }}>Add Department</h1>
            <p style={{ color: '#64748b', fontSize: '1rem', maxWidth: '600px', lineHeight: 1.5 }}>
              Register a new administrative and clinical unit for the hospital directory.
            </p>
          </div>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <form id="add-dept-form" onSubmit={handleAdd} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div style={{ backgroundColor: 'white', borderRadius: '1rem', padding: '2.5rem', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
              ...
              <div>
                ...
                <textarea 
                  required
                  placeholder="Provide details about specialization and focus areas..."
                  rows="4"
            ...
            <div style={{ backgroundColor: 'white', borderRadius: '1rem', padding: '2.5rem', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1fr) minmax(0,1fr)', gap: '1.5rem', alignItems: 'end' }}>
                <div>
                  <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.75rem' }}>Total Doctors Expected</label>
                  <input 
                    type="number" 
                    placeholder="0"
